  ...
  return (
    <>
      ...
      <div className="content">
        <div className="h1">Solana
Ethereum
Base</div>
        <div className="d1">
        Our platform provides a seamless and user-friendly experience for launching blockchain projects on Solana, Ethereumand and Base.
         With our robust infrastructure and expert support, we ensure your project's success from inception to deployment and beyond.
